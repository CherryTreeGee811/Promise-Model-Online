...
#pragma warning disable S1135 // "todo" text in XML comments refers to the status name, not a task
...
/// <remarks>
///   Color mapping: Done = green, InProgress = orange, Blocked = black, to-do = red.
...
public static class StatusColorRules
{
    ...
    public static string FromMomentStatus(MomentStatus status) => status switch
    {
    ...
    /// <remarks>
    ///   If all children are Done -> Done. All Blocked -> Blocked. All to-do -> to-do.
