...
{
    /// <summary>REST controller for journey CRUD with epic-scoped queries and description updates.</summary>
    /// <remarks>Route disabled — use <c>ProjectJourneysController</c> instead.</remarks>
    ...
    public class JourneysController : GenericController<Journey, JourneyDTO>
    {
        ...
        /// <summary>Return all journeys, optionally filtered by epic ID.</summary>
        ...
        /// <param name="id">The journey ID.</param>
        /// <param name="request">The description update request.</param>
        /// <returns>The updated journey DTO.</returns>
        [Authorize(Policy = "projects.write")]
