...
[ApiController]
[Route("api/comments")]
public class SearchCommentsController(ICommentRepository commentRepository, ILogger<SearchCommentsController> logger) : ControllerBase
{
    private readonly ICommentRepository _commentRepository = commentRepository;
    private readonly ILogger<SearchCommentsController> _logger = logger;
