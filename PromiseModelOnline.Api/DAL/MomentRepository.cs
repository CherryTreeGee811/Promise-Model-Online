...
public class MomentRepository(PromiseModelOnlineContext context) : GenericRepository<Moment>(context), IMomentRepository
{
    ...
    private IQueryable<Moment> BuildMomentQuery() => _context.Set<Moment>()
