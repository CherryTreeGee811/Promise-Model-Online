...
export function loadKnowledgeBase() {
    ...
    kbContent.innerHTML = [
      section('The Promise Stack Overview', `
      ...
      `),
      section('Promise 0 (Universal Standards)', `
      ...
      `),
      section('Promise Discovery (The Sandbox)', `
