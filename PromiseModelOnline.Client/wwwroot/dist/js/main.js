...
var e=`pmo.auth`,t=!1,n=null,r=null;function i(){try{let i=sessionStorage.getItem(e);if(i){let e=JSON.parse(i);t=!!e.isAuthenticated,n=e.username||null,r=e.userId??null}}catch{}}function a(){try{sessionStorage.setItem(e,JSON.stringify({isAuthenticated:t,username:n,userId:r}))}catch{}}function o(e){t=!!e.isAuthenticated,n=e.username||null,r=e.userId??null,a()}function s(){t=!1,n=null,r=null;try{sessionStorage.removeItem(e)}catch{}}function c(){return t}function l(){return n}function u(){return r}i();function d(){let e=c()?`
