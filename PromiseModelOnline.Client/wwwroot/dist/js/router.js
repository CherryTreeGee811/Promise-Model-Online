...
import{S as e,_ as t,a as n,b as r,c as i,d as a,f as o,g as s,h as c,i as l,l as u,loadTemplate as d,loadTemplateWithError as f,m as p,n as m,navigate as h,o as g,p as _,r as v,s as y,showNotFound as b,t as x,u as S,x as C,y as w}from"./main.js";import{$ as T,A as E,B as ee,C as D,D as O,E as k,F as A,G as j,H as M,I as te,J as ne,K as re,L as ie,M as ae,N as oe,O as se,P as ce,Q as le,R as ue,S as de,T as fe,U as pe,V as me,W as he,X as ge,Y as _e,Z as ve,_ as ye,a as N,at as be,b as xe,c as P,ct as Se,d as Ce,dt as we,f as Te,ft as Ee,g as F,h as De,ht as Oe,i as ke,it as Ae,j as je,k as Me,l as Ne,lt as Pe,m as Fe,mt as Ie,n as Le,nt as Re,o as I,ot as ze,p as Be,pt as Ve,q as He,rt as Ue,s as We,st as Ge,t as Ke,u as qe,ut as Je,v as Ye,w as Xe,x as Ze,y as Qe,z as $e}from"./iteration-create-modal.js";function et(e,t){let n=document.getElementById(`project-list-table-body`),r=document.getElementById(`error-text`),i=document.getElementById(`success-text`),a=document.getElementById(`add-project-link`);!n||!r||!i||(a&&a.addEventListener(`click`,n=>{n.preventDefault(),h(`/projects/add`,e,t)}),r.textContent=``,i.textContent=``,n.innerHTML=``,be().then(r=>{if(!r||r.length===0){n.innerHTML=v({icon:`bi-folder`,title:`There are no projects yet`,description:`Click "Add Project" to create your first project.`,colspan:2,button:{text:`Create your first project`,icon:`bi-plus-circle`,id:`empty-state-add-project-btn`}});let r=document.getElementById(`empty-state-add-project-btn`);r&&r.addEventListener(`click`,n=>{n.preventDefault(),h(`/projects/add`,e,t)});return}r.forEach(e=>{let t=document.createElement(`tr`);t.innerHTML=`
    ...
    `,e.querySelector(`.backlog-content table.promisemodel-table tbody`)):null}function Jt(e){let t=document.createElement(`tr`);t.dataset.momentId=String(e.sequenceNumber),t.innerHTML=`
        <td>${l(e.statement)}</td>
    ...
    `;let n=t.querySelector(`.backlog-target-stride`);return n&&on(n),t}function Yt(e){let t=document.querySelector(`.stride-card[data-stride-id="${e}"]`);if(!t)return null;let n=t.querySelector(`table.promisemodel-table tbody`);if(n)return n;let r=t.querySelector(`.stride-moments`);return r?(r.innerHTML=`
        <table class="promisemodel-table">
            <thead>
                <tr>
                    <th>Statement</th>
    ...
    `,t.querySelector(`table.promisemodel-table tbody`)):null}function Xt(e){let t=document.createElement(`tr`);t.dataset.momentId=String(e.sequenceNumber),t.innerHTML=`
        <td>${l(e.statement)}</td>
        <td>${Et(e.sequenceNumber,e.type)}</td>
        <td><span class="status-badge status-${(e.status||``).toLowerCase()}">${e.status}</span></td>
    ...
    `,e.querySelector(`tbody`)}function Xr(e,t){let n=e.querySelector(`tr[data-inline-add-row="1"]`);if(n){e.insertBefore(t,n);return}e.appendChild(t)}function Zr(e){e.querySelector(`.inline-table-empty-row`)?.remove()}var Qr=(e,n,r,i)=>t(`/api/comments?type=${r}&parentId=${i}`),$r=(e,t,n)=>r(`/api/comments`,n),ei={View:0,Comment:1,Edit:2,Owner:3};function ti(e,t){return(ei[e]??0)>=(ei[t]??0)}async function $(e,t){try{let n=await Se(e,t);return n?typeof n==`string`?{permission:n,isOwner:n===`Owner`}:{permission:n.permission??void 0,isOwner:n.isOwner===!0}:{permission:void 0,isOwner:!1}}catch{return{permission:void 0,isOwner:!1}}}function ni(e,t,n,r,i,a){let o=ti(a?.permission,`Comment`);e.innerHTML=`
        <h3>Comments</h3>
    ...
    `;let s=e.querySelector(`#comments-list`),c=e.querySelector(`#comment-form`),l=e.querySelector(`#comment-textarea`);l&&H(l,t,n);let u=Z(t,n,r,i);Promise.all([Qr(r,i,t,n),u]).then(([e])=>ri(s,e,o)).catch(()=>{s.removeAttribute(`role`),s.removeAttribute(`aria-label`),s.innerHTML=`<p class="error">Failed to load comments.</p>`}),c&&c.addEventListener(`submit`,async e=>{e.preventDefault();let a=l.value.trim();if(a)try{let e=window.scrollY;ii(s,await $r(r,i,{parentType:t,parentId:n,text:a})),l.value=``,window.scrollTo(0,e)}catch(e){alert(`Failed to post comment.`),console.error(e)}})}function ri(e,t,n){if(e.innerHTML=``,!t||t.length===0){e.innerHTML=m({icon:`bi-chat-dots`,title:`No comments yet.`,description:n?`Be the first to share your thoughts.`:``});return}t.forEach(t=>e.appendChild(ai(t)))}function ii(e,t){let n=e.querySelector(`.no-items`);n&&n.remove(),e.appendChild(ai(t))}function ai(e){let t=document.createElement(`div`);return t.className=`comment-item`,t.innerHTML=`
        ...
        `).join(``)}</div>`:``}
    `,t}var oi=(e,n,r,i)=>t(`/api/reactions?type=${r}&itemId=${i}`),si=(e,t,n)=>r(`/api/reactions`,n),ci=(e,t,n)=>w(`/api/reactions/${n}`,{}),li=[`👍`,`👎`,`❤️`,`😀`,`🎉`,`🚀`,`👀`];function ui(t,n,r,i,a,o){t.innerHTML=`
        <div class="reactions-bar">
            ...
            ${o?.permission===`Comment`||o?.permission===`Edit`?`<span class="reactions-picker">
                ${li.map(e=>`<button class="btn btn-outline-secondary btn-sm emote-btn" data-emote="${e}" title="${e}" aria-label="React with ${e}">${e}</button>`).join(``)}
            </span>`:``}
        </div>
    `;let s=t.querySelector(`#reactions-summary`),c=t.querySelectorAll(`.emote-btn`),l=e(),u={counts:{},myReactionId:null,myEmote:null};function d(){s.textContent=li.filter(e=>u.counts[e]).map(e=>`${e} ${u.counts[e]}`).join(` `)||`No reactions yet.`}async function f(){try{let e=await oi(i,a,n,r);if(u.counts={},(e||[]).forEach(e=>{u.counts[e.emote]=(u.counts[e.emote]||0)+1}),l){let t=(e||[]).find(e=>String(e.userName)===String(l));u.myReactionId=t?.id??null,u.myEmote=t?.emote??null}d()}catch{s.textContent=`Failed to load reactions.`}}f(),c.forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.emote;try{let e=window.scrollY,o=u.myReactionId?await ci(i,a,u.myReactionId,t):await si(i,a,{parentType:n,parentId:r,emote:t}),s=u.myEmote,c=o?.emote??t;s&&s!==c&&(u.counts[s]=Math.max(0,(u.counts[s]||0)-1)),(!s||s!==c)&&(u.counts[c]=(u.counts[c]||0)+1),u.myReactionId=o?.id??u.myReactionId,u.myEmote=c,d(),window.scrollTo(0,e)}catch{alert(`Failed to react`)}})})}function di(){let e=document.getElementById(`back-link`);e&&e.addEventListener(`click`,()=>window.history.back())}function fi(e,t,n,r,i,a){let o=document.getElementById(`${t.toLowerCase()}-comments`);o&&ni(o,t,n,r,i,a);let s=document.getElementById(`reactions-section`);s||(s=document.createElement(`div`),s.id=`reactions-section`),e&&(s.parentNode||e.appendChild(s),ui(s,t,n,r,i,a))}function pi(e,t,n,r,i,a){let o=document.getElementById(`promise-detail-content`),s=document.getElementById(`error-text`),c=document.getElementById(`promise-detail-loading`);Le(),c&&(c.hidden=!1),s.textContent=``,M(e,t,n).then(n=>Promise.all([Promise.resolve(n),Z(`Promise`,n.id,e,t)])).then(([s])=>{c&&(c.hidden=!0),o.innerHTML=`
            ...
            `,c&&(c.hidden=!0);let u=document.getElementById(`description-input`),d=document.getElementById(`description-view`),f=document.getElementById(`edit-desc-btn`),p=document.getElementById(`save-desc`),m=document.getElementById(`cancel-desc`),g=null;u&&d&&f&&(H(u,`Promise`,s.id),g=Y(u,d,f,p,m)),ke({nodeType:`promise`,nodeId:n,owner:e,project:t});let _=document.getElementById(`promise-epics-list`);me(e,t,n).then(a=>{N(`promise-${s.sequenceNumber}`,a);let c=Yr(_,{headers:[`Statement`,`Actions`],items:a||[],emptyMessage:`No epics found for this promise.`,renderItemRow:n=>`
                    ...
                    `,o.querySelectorAll(`a[epic-id]`).forEach(n=>{n.addEventListener(`click`,a=>{a.ctrlKey||a.metaKey||a.button===1||(a.preventDefault(),h(`/${e}/${t}/epics/${n.getAttribute(`epic-seq`)}`,r,i))})})}).catch(()=>{_&&(_.innerHTML=`<p class="error">Failed to load epics.</p>`)}),(function(){if(a?.permission!==`Edit`){let e=document.getElementById(`edit-desc-btn`),t=document.getElementById(`save-desc`),n=document.getElementById(`description-input`);e&&(e.disabled=!0,e.title=`Requires Edit permission.`),t&&(t.disabled=!0,t.title=`Requires Edit permission.`),n&&(n.disabled=!0);let r=document.getElementById(`add-epic-statement`),i=document.getElementById(`add-epic-submit`);r&&(r.disabled=!0),i&&(i.disabled=!0,i.title=`Requires Edit permission.`)}})(),fi(o,`Promise`,s.id,e,t,a);let{owner:v,project:y}=rt();v&&y&&it(o,L(v,y,`promise-${s.sequenceNumber}`)),di();let b=document.getElementById(`desc-save-msg`);p&&p.addEventListener(`click`,async r=>{r.preventDefault(),b&&(b.textContent=``),p.disabled=!0;let i=document.getElementById(`description-input`).value;try{s.description=(await he(e,t,n,i))?.description??(i.trim()?i:null),I(`promise-${s.sequenceNumber}`,{description:s.description}),g&&g.showSavedPopover&&g.showSavedPopover(Q(s.description||``))}catch(e){b&&(b.textContent=`Save failed`),console.error(e)}finally{p.disabled=!1}}),c&&(c.hidden=!0)}).catch(e=>{c&&(c.hidden=!0),s&&(s.textContent=`Failed to load promise details.`),console.error(e)})}function mi(e,t,n,r,i,a){let o=document.getElementById(`epic-detail-content`),s=document.getElementById(`error-text`),c=document.getElementById(`epic-detail-loading`);Le(),c&&(c.hidden=!1),s.textContent=``,te(e,t,n).then(n=>Promise.all([Promise.resolve(n),Z(`Epic`,n.id,e,t)])).then(([s])=>{c&&(c.hidden=!0),ke({nodeType:`epic`,nodeId:n,owner:e,project:t}),o.innerHTML=`
            ...
            `;let u=document.getElementById(`description-input`),d=document.getElementById(`description-view`),f=document.getElementById(`edit-desc-btn`),p=document.getElementById(`save-desc`),m=document.getElementById(`cancel-desc`),g=null;u&&d&&f&&(H(u,`Epic`,s.id),g=Y(u,d,f,p,m));let _=document.getElementById(`epic-parent-promise`);pe(e,t,s.productPromiseId).then(n=>{let a=D(n.statusColor),o=Xe(n.statusColor);_.innerHTML=`<a href="/${e}/${t}/promises/${n.sequenceNumber}" class="detail-link link-primary text-decoration-none fw-semibold">${l(n.statement)}</a> <span aria-hidden="true">${a}</span><span class="sr-only">${o}</span>`;let s=_.querySelector(`a.detail-link`);s&&s.addEventListener(`click`,e=>{e.ctrlKey||e.metaKey||e.button===1||(e.preventDefault(),h(s.getAttribute(`href`),r,i))})}).catch(()=>{_.textContent=`Promise ${s.productPromiseId}`});let v=document.getElementById(`epic-journeys-list`);ue(e,t,n).then(a=>{N(`epic-${s.sequenceNumber}`,a);let o=Yr(v,{headers:[`Statement`,`Actions`],items:a||[],emptyMessage:`No journeys found for this epic.`,renderItemRow:n=>`
                    ...
                    `,v.querySelectorAll(`a[journey-id]`).forEach(n=>{n.addEventListener(`click`,a=>{a.ctrlKey||a.metaKey||a.button===1||(a.preventDefault(),h(`/${e}/${t}/journeys/${n.getAttribute(`journey-seq`)}`,r,i))})})}).catch(()=>{v.innerHTML=`<p class="error">Failed to load journeys.</p>`}),di(),(function(){if(a?.permission!==`Edit`){let e=document.getElementById(`edit-desc-btn`),t=document.getElementById(`save-desc`),n=document.getElementById(`description-input`);e&&(e.disabled=!0,e.title=`Requires Edit permission.`),t&&(t.disabled=!0,t.title=`Requires Edit permission.`),n&&(n.disabled=!0);let r=document.getElementById(`add-journey-statement`),i=document.getElementById(`add-journey-submit`);r&&(r.disabled=!0),i&&(i.disabled=!0,i.title=`Requires Edit permission.`)}})(),fi(o,`Epic`,s.id,e,t,a);let y=document.getElementById(`desc-save-msg`);p&&p.addEventListener(`click`,async r=>{r.preventDefault(),y.textContent=``,p.disabled=!0;let i=document.getElementById(`description-input`).value;try{s.description=(await $e(e,t,n,i))?.description??(i.trim()?i:null),I(`epic-${s.sequenceNumber}`,{description:s.description}),g&&g.showSavedPopover(Q(s.description||``))}catch(e){y.textContent=`Save failed`,console.error(e)}finally{p.disabled=!1}});let{owner:b,project:x}=rt();b&&x&&it(o,L(b,x,`epic-${s.sequenceNumber}`))}).catch(e=>{c&&(c.hidden=!0),s.textContent=`Failed to load epic details.`,console.error(e)})}function hi(e,t,n,r,i,a){let o=document.getElementById(`journey-detail-content`),s=document.getElementById(`error-text`),c=document.getElementById(`journey-detail-loading`);Le(),c&&(c.hidden=!1),s.textContent=``,ae(e,t,n).then(n=>Promise.all([Promise.resolve(n),Z(`Journey`,n.id,e,t)])).then(([s])=>{c&&(c.hidden=!0),ke({nodeType:`journey`,nodeId:n,owner:e,project:t}),o.innerHTML=`
        ...
        `}),u=e.querySelector(`#add-moment-task-name`),d=e.querySelector(`#add-moment-task-description`),f=e.querySelector(`#add-moment-task-completed`),p=e.querySelector(`#add-moment-task-submit`),m=e.querySelector(`#add-moment-task-msg`);d&&H(d,`Moment`,r.id),ti(a?.permission,`Edit`)||(u&&(u.disabled=!0),d&&(d.disabled=!0),f&&(f.disabled=!0),p&&(p.disabled=!0,p.title=`Requires Edit permission.`)),p&&u&&d&&f&&m&&p.addEventListener(`click`,async()=>{m.textContent=``;let e=u.value.trim();if(!e){m.textContent=`Name is required.`;return}p.disabled=!0;try{let n=await i(o,s,t,{name:e,description:d.value.trim(),isCompleted:f.checked});if(n){Zr(c);let e=document.createElement(`tr`);e.dataset.momentTaskId=n.id,e.innerHTML=`
                    ...
                    `,Xr(c,e),u.value=``,d.value=``,f.checked=!1,Array.isArray(r.tasks)||(r.tasks=[]),r.tasks.push(n),yi(t,r),bi(c,t,r,null,o,s)}}catch(e){m.textContent=`Failed to add task.`,console.error(e)}finally{p.disabled=!1}}),bi(c,t,r,a,o,s)}function yi(e,t){I(`moment-${t.sequenceNumber}`,{tasks:Array.isArray(t?.tasks)?[...t.tasks]:[]})}function bi(e,t,n,r,i,a){if(!e)return;let o=ti(r?.permission,`Edit`);e.querySelectorAll(`.moment-task-complete-checkbox`).forEach(e=>{if(e.dataset.bound!==`1`){if(e.dataset.bound=`1`,!o){e.disabled=!0,e.title=`Requires Edit permission.`;return}e.addEventListener(`change`,async()=>{let r=Number.parseInt(String(e.dataset.momentTaskId??``),10),o=e.closest(`tr`)?.querySelector(`.moment-task-completion span`),s=!e.checked;e.disabled=!0;try{let s=await c(i,a,t,r,e.checked);if(s){e.checked=!!s.isCompleted,o&&(o.textContent=s.isCompleted?`Completed`:`Open`);let i=(n.tasks??[]).find(e=>Number(e.id)===r);i&&(i.isCompleted=s.isCompleted,yi(t,n))}else o&&(o.textContent=e.checked?`Completed`:`Open`)}catch(t){e.checked=s,o&&(o.textContent=s?`Completed`:`Open`),alert(`Failed to update task completion`),console.error(t)}finally{e.disabled=!1}})}})}function xi(e,t,n){switch(e){case`/projects`:d(`projects/list.html`,n).then(()=>et(t,n)).catch(f(n,`project list`));break;case`/projects/add`:d(`projects/add.html`,n).then(()=>nt(t,n)).catch(f(n,`add project form`));break;default:b(n)}}function Si(e,t,n,r,i){let a=n.replace(/^\/+/,``).replace(/\/+$/,``),o=a?a.split(`/`):[];if(o.length===0){$(e,t).then(n=>{un(e,t,r,i,n)});return}let s=o[0],c=o[1];switch(!0){case s===`strides`:$(e,t).then(n=>{un(e,t,r,i,n)});break;case s===`graph`:Promise.all([d(`projects/graph.html`,i),$(e,t)]).then(([,n])=>Dr(e,t,i,n)).catch(f(i,`graph page`));break;case s===`settings`:Promise.all([d(`projects/settings.html`,i),$(e,t)]).then(([,n])=>Wr(r,i,e,t,n)).catch(f(i,`project settings`));break;case s===`share`:Promise.all([d(`projects/share.html`,i),$(e,t)]).then(([,n])=>pn(e,t,i,n)).catch(f(i,`share page`));break;case s===`history`:d(`projects/history.html`,i).then(()=>Jr(r,i,e,t)).catch(f(i,`project activity`));break;case s===`iterations`:Promise.all([d(`iterations/list.html`,i),$(e,t)]).then(([,n])=>{x(()=>import(`./list.js`).then(r=>{r.loadIterationHistory(e,t,n)}),__vite__mapDeps([0,1,2]))}).catch(f(i,`iterations`));break;case s===`promises`&&!!c:Promise.all([d(`promises/detail.html`,i),$(e,t)]).then(([,n])=>pi(e,t,c,r,i,n)).catch(f(i,`promise`));break;case s===`epics`&&!!c:Promise.all([d(`epics/detail.html`,i),$(e,t)]).then(([,n])=>mi(e,t,c,r,i,n)).catch(f(i,`epic`));break;case s===`journeys`&&!!c:Promise.all([d(`journeys/detail.html`,i),$(e,t)]).then(([,n])=>hi(e,t,c,r,i,n)).catch(f(i,`journey`));break;case s===`flows`&&!!c:Promise.all([d(`flows/detail.html`,i),$(e,t)]).then(([,n])=>gi(e,t,c,r,i,n)).catch(f(i,`flow`));break;case s===`moments`&&!!c:Promise.all([d(`moments/detail.html`,i),$(e,t)]).then(([,n])=>_i(e,t,c,r,i,n)).catch(f(i,`moment`));break;default:b(i)}}export{xi as handleLegacyProjectRoutes,Si as handleProjectScopedRoutes};